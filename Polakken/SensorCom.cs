...
namespace Polakken
{
    internal static class SensorCom
    {
        private const string Module = "SensorCom";
        public static int AlarmLimit { get; set; }
        //Brukes ikke internt i klassen, men bestemmer hvor lav temperatur som skal til før en alarm sendes. 
        public static int MesInterval { get; set; }
        //Brukes ikke internt i klassen, men bestemmer hvor ofte det gjøres en måling. 
        ...
        public static bool Connected()
        {
            ...
            try
            {
                ...
                var reader = new AnalogSingleChannelReader(checkConnection.Stream);
                reader.ReadSingleSample();
                // Lagrer ikke svar fra sensor, fordi det er denne linjen som kaster exception.  
                connected = true;
            }
            catch (Exception)
            {
